class Qubit:
    ...
    This base class means that we can hold the position and index of each qubit within itself and use some helper methods too.
    """

    def __init__(self, index: int, position: tuple[int, int]) -> None:
        self.index = index        
